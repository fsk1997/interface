    ...
    <div className={styles.page}>
      ...
      <div className={styles.container} style={{ padding: 16 }}>
        <p>
          ...
          for the Oceans」とのコラボレーションから誕生した「adidas Originals by
        ...
        <figure>
          ...
          <figcaption>
            ...
            ソックス￥1,639／すべて adidas Originals （アディダスお客様窓口）
            トップス￥35,200 ／BASICKS（ベイシックス） ビスチェ￥61,600／RYO
            TOMINAGA （ザナドゥ トウキョウ） ピアス￥30,800／FLAN（ショールーム
            シャルメール）
          </figcaption>
        </figure>
        ...
        <figure>
          ...
          <figcaption>
            ...
            adidas Originals （アディダスお客様窓口）
            トップス￥13,200／K3&CO.（ケイスリー オフィス）
            タンクトップ￥4,950／GINA TRICOT（サスティナブル ケイスリー）
            パンツ￥52,800、ベルト￥9,900／ともにDIESEL（ディーゼルジャパン）
            ベレー帽￥13,200／LAULHÉRE（クオリネスト）
            サングラス￥62,700／THIERRY LASRY（サンライズエージェント株式会社）
          </figcaption>
        </figure>
        <p>
